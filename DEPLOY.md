...
- Select this repo: `gabrielpc4/video-peeker-transcriber-backend`
...
Render gives you a URL like `https://video-peeker-transcriber-backend.onrender.com`.
...
```bash
git clone git@github.com:gabrielpc4/video-peeker-transcriber-backend.git
cd video-peeker-transcriber-backend
mkdir -p data
