    ...
    init() {
        ...
        do {
            guard let containerUrl = FileManager.default.containerURL(
                ...
                throw NSError(domain: "VideoPeekApp", code: 1, userInfo: [NSLocalizedDescriptionKey: "Missing App Group container URL."])
            }
            ...
            print("[VideoPeek] Failed to create AppGroup SwiftData store: \(error.localizedDescription)")
        }
    }
